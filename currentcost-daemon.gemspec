Gem::Specification.new do |s|
  ...
  s.files += ["lib/currentcostd/publishers/debug.rb", "lib/currentcostd/publishers/pachube.rb", "lib/currentcostd/publishers/http.rb", "lib/currentcostd/publishers/carbondiet.rb"]
  s.files += ["config/currentcostd.example.yml"]
  s.files += ["bin/currentcostd"]
  s.executables = ['currentcostd']
  s.add_dependency('Floppy-currentcost', [">= 0.2.4"])
